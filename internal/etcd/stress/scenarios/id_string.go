...
const _StressIDName = "CONCURRENT_PUTSBURST_WRITESSUSTAINED_LOADRAMP_UP_LOADMIXED_WORKLOADLARGE_VALUESMANY_KEYSHIGH_CONTENTIONSEQUENTIAL_WRITESRANDOM_READSWATCH_PROGRESS_NOTIFYLEASE_INTENSIVE_WORKLOADLIST_PAGINATION_HEAVYOPTIMISTIC_CONCURRENCY_TXNWATCH_MANY_PREFIXESCOMPACT_DURING_LOADWATCH_WITH_CHURNNAMESPACE_ISOLATION_HEAVYTXN_MULTI_KEY_UPDATELEADER_ELECTION_CONTENTIONWATCH_BOOKMARK_HEAVY"

var _StressIDIndex = [...]uint16{0, 15, 27, 41, 53, 67, 79, 88, 103, 120, 132, 153, 177, 198, 224, 243, 262, 278, 303, 323, 349, 369}
