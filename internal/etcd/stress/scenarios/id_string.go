...
const _StressIDName = "CONCURRENT_PUTSBURST_WRITESSUSTAINED_LOADRAMP_UP_LOADMIXED_WORKLOADLARGE_VALUESMANY_KEYSHIGH_CONTENTIONSEQUENTIAL_WRITESRANDOM_READSWATCH_PROGRESS_NOTIFYLEASE_INTENSIVE_WORKLOADLIST_PAGINATION_HEAVYOPTIMISTIC_CONCURRENCY_TXNWATCH_MANY_PREFIXESCOMPACT_DURING_LOADWATCH_WITH_CHURNNAMESPACE_ISOLATION_HEAVYTXN_MULTI_KEY_UPDATELEADER_ELECTION_CONTENTIONWATCH_BOOKMARK_HEAVYK8S_POD_LIFECYCLE_CHURNK8S_NODE_HEARTBEAT_LEASESK8S_MIXED_APISERVERK8S_CRD_HEAVY_CHURNK8S_JOB_STORM"

var _StressIDIndex = [...]uint16{0, 15, 27, 41, 53, 67, 79, 88, 103, 120, 132, 153, 177, 198, 224, 243, 262, 278, 303, 323, 349, 369, 392, 417, 436, 455, 468}
